...
export const DiamondIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9.75 0h.008v.008H12v-.008L10.5 21zm.15-5.625L12 12m0 0l1.35 3.375M12 12l-1.35 3.375M12 12l-1.5-1.5m1.5 1.5l1.5 1.5m-1.5-1.5l1.5-1.5M3 10.5l5.25 11.25L13.5 3 3 10.5z" />
    </svg>
);
...
export const ShoppingBagIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.658-.463 1.243-1.117 1.243H4.502c-.654 0-1.187-.585-1.117-1.243l1.263-12a1.125 1.125 0 011.117-1.007h10.518c.654 0 1.187.585 1.117 1.007zM12 15.75a.75.75 0 01.75.75v3.375a.75.75 0 01-1.5 0V16.5a.75.75 0 01.75-.75z" />
    </svg>
);
